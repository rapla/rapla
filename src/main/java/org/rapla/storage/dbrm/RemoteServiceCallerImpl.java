...
public class RemoteServiceCallerImpl implements RemoteServiceCaller
{
    ...
    @Inject public RemoteServiceCallerImpl(CommandScheduler commandQueue, Logger callLogger, RemoteConnectionInfo remoteConnectionInfo, RaplaResources i18n)
    {
        super();
    ...
    {
        final BasicRaplaHTTPConnector basicRaplaHTTPConnector;
        try
        {
            final Class<? extends BasicRaplaHTTPConnector> aClass = (Class<? extends BasicRaplaHTTPConnector>) Class
                    .forName(a.getCanonicalName() + "_JavaJsonProxy");
            final Constructor<? extends BasicRaplaHTTPConnector> constructor = aClass.getConstructor(CustomConnector.class);
            basicRaplaHTTPConnector = constructor.newInstance(connector);
...
/*
        ...
        InvocationHandler proxy = new InvocationHandler()
        {
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable
            {
                ...
                try
                {
                    Object result = method.invoke(basicRaplaHTTPConnector, args);
