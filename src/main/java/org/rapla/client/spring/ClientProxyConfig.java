...
public class ClientProxyConfig
{
    ...
    @Bean
    public org.rapla.enpoints.RemoteLogger remoteLoggerProxy(HttpServiceProxyFactory factory)
    {
        return factory.createClient(org.rapla.enpoints.RemoteLogger.class);
    }
