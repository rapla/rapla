...
public abstract class AbstractRestPage implements RaplaPageGenerator, RemoteJsonService
{
    ...
    private final String updatetMethod;
    ...
    @Override public void generatePage(ServletContext servletContext, HttpServletRequest request, HttpServletResponse response)
