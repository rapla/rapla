    ...
    AppointmentFormater
{
    ...
    {
        i18n = sm.lookup(RaplaComponent.RAPLA_RESOURCES);
        loc =  sm.lookup(RaplaLocale.class);
    }
    ...
    */
    private boolean isSameDay( Date d1, Date d2 ) {
        Calendar createCalendar = loc.createCalendar();
        return DateTools.isSameDay( createCalendar, d1, d2 );
    }
