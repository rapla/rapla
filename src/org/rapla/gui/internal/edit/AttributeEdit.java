    ...
    RaplaWidget
{
    ...
    public AttributeEdit(RaplaContext sm) {
        super( sm);
        ...
        ,ChangeListener
{
    ...
    DefaultConstraints(RaplaContext sm){
        super( sm );
    ...
    private void update() {
        ...
        multiSelectLabel.setVisible( categoryVisible);
        multiSelect.getComponent().setVisible( categoryVisible);
    }
