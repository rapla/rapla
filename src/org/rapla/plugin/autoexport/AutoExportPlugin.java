...
public class AutoExportPlugin implements PluginDescriptor<ClientServiceContainer>
{
    ...
    public static final TypedComponentRole<RaplaMap<CalendarModelConfiguration>> PLUGIN_ENTRY = new TypedComponentRole<RaplaMap<CalendarModelConfiguration>>("org.rapla.plugin.autoexport");
