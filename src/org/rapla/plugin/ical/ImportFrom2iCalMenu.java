...
public class ImportFrom2iCalMenu extends RaplaGUIComponent implements IdentifiableMenuEntry, ActionListener {
	...
	public ImportFrom2iCalMenu(RaplaContext sm){
		super(sm);
		...
		dlg.getButton(0).setAction(new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
                    ...
                    Integer[] status  = getWebservice( ICalImport.class).importICal(iCal, isURL, allocatableIds, eventTypeKey, eventTypeAttributeNameKey);
