...
public class RaplaMetaConfigInfo  extends HashMap<String,ComponentInfo> {
    ...
    public RaplaMetaConfigInfo() {
        ...
        put( "rapla-server", new ComponentInfo("org.rapla.server.internal.ServerServiceImpl",new String[]{"org.rapla.server.ServerServiceContainer","org.rapla.storage.dbrm.RemoteMethodStub"}));
