    ...
    implements Namespaces
{
    ...
    protected void printTimestamp(Timestamp stamp) throws IOException {
        ...
        try
        {
	        if ( createTime != null)
	        {
	            att("created-at", dateTimeFormatTimestamp.formatTimestamp( createTime));
			}
	        if ( lastChangeTime != null)
	        {
	            att("last-changed", dateTimeFormatTimestamp.formatTimestamp( lastChangeTime));
	        }
        } 
        catch (ArrayIndexOutOfBoundsException ex)
        {
        	getLogger().error("Error printing time create: " + createTime + " lastChanged " + lastChangeTime);
        	throw ex;
        }
