...
//    RemoteMethod GET_RESERVATIONS= new RemoteMethod("getReservations", new String[] {"start","end"});
    ...
    Integer[][] getFirstAllocatableBindings(SimpleIdentifier[] allocatables, Appointment[] appointments, SimpleIdentifier[] ignoreList) throws RaplaException;
    EntityList getAllAllocatableBindings(SimpleIdentifier[] allocatables, Appointment[] appointments, SimpleIdentifier[] ignoreList) throws RaplaException;
