...
public class CopyPeriodPluginTest extends RaplaTestCase {
    ...
    public void test() throws Exception {
        ...
        BooleanFieldFactory booleanFieldFactory = new BooleanFieldFactory(facade, raplaResources, raplaLocale, logger, permissionController);
        Provider<CopyDialog> copyDialogProvider = new SimpleProvider<CopyDialog>(new CopyDialog(getClientService().getContext(), i18n, model, dateRenderer, booleanFieldFactory, dialogUiFactory));
