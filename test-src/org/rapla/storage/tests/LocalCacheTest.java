...
public class LocalCacheTest extends RaplaTestCase {
    ...
    public void testConflicts() throws Exception {
        ...
        //start is 13/3  original end = 28/3
        Date startDate = getRaplaLocale().toDate(2013, 3, 13);
        Date endDate = getRaplaLocale().toDate(2013, 3, 28);
