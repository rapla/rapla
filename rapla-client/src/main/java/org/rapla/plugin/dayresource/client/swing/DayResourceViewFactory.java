...
public class DayResourceViewFactory implements SwingViewFactory
{
    ...
    {
        return new SwingDayResourceCalendar(facade, i18n, raplaLocale, model, editable, printing, objectMenuFactories, menuFactory, dateRendererProvider,
