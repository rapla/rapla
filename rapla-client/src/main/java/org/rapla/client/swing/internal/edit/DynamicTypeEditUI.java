     ...
     EditComponent<DynamicType,JComponent>
{
    ...
    public DynamicTypeEditUI(ClientFacade facade, RaplaResources i18n, RaplaLocale raplaLocale, final AttributeEdit attributeEdit, Set<AnnotationEditTypeExtension> annotationExtensions, final DialogUiFactoryInterface dialogUiFactory, final PermissionListFieldFactory permissionListFieldFactory, MultiLanguageFieldFactory multiLanguageFieldFactory, TextFieldFactory textFieldFactory, IOInterface ioInterface) throws RaplaInitializationException {
        ...
        double[][] sizes = new double[][] {
            ...
            ,{PRE,5,PRE,5,PRE,5,PRE,5,PRE,5,PRE,5,PRE,5,TableLayout.FILL,5,PRE,5,PRE}
        };
...
//        editPanel.add(annotationPanel,"1,6,3,6");
...
//        }));
        ...
        editPanel.add(new JLabel(getString("color")+ ":"),"1,8");
        editPanel.add(colorChooser,"3,8");
        editPanel.add(annotationLabel,"1,10");
        editPanel.add(annotationText ,"3,10");
        editPanel.add(annotationDescription,"3,12");
        ...
        editPanel.add(this.permissionListField.getComponent(),"1,16,3,16");
...
//        }
    ...
    public void mapFromObjects() throws RaplaException
    {
        ...
        {
            permissionListField.setPermissionLevels(Permission.READ_TYPE, Permission.CREATE, Permission.READ,Permission.EDIT, Permission.ADMIN);
