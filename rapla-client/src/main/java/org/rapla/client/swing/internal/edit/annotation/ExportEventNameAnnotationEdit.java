...
public class ExportEventNameAnnotationEdit extends RaplaGUIComponent implements AnnotationEditTypeExtension
{
    ...
    @Autowired
    public ExportEventNameAnnotationEdit(ClientFacade facade, RaplaResources i18n, RaplaLocale raplaLocale, IOInterface ioInterface, TextFieldFactory textFieldFactory) {
