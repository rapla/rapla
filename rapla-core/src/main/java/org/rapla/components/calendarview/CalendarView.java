...
{
    /** returns the first LocalDateTime that will be displayed in the calendar */
    LocalDateTime getStartDate();
    /** returns the last LocalDateTime that will be displayed in the calendar */
    LocalDateTime getEndDate();

    /** sets the calendarview to the selected date*/
    /** Distinct method name to avoid {@code setToDate(null)} ambiguity. */
    void setToDate(LocalDateTime weekDate);
