...
**Status:** wont-fix — 2026-09-13 — never built; the DHBW deployment now authenticates via Keycloak ([PRD 036](../036-external-idp-oauth-login.md), OAuth), and the URL-token/localStorage design contradicts [PRD 072](../done/072-server-side-login-dialog.md)/[PRD 102](../102-browser-credential-hardening.md).
**Date:** 2026-05-15
