...
**Status:** done (2026-05-11). The ~1,068 lines of collateral damage from the PRD 001-A Phase 4 scripts were recovered via the file-reset + re-script approach. PRD 015 explicitly records the final state: "100 % of the diff is Date migration work. All script collateral has been recovered." Reactor compiles green and `mvn test` runs end-to-end.
